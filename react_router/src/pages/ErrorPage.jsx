...
export const ErrorPage = () => {
  ...
  if (error.status === 404) {
    return (
      <section className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-100">
        <div id="error-text" className="text-center space-y-6">
          ...
          <p className="text-lg text-gray-400">It seems you lost your way.</p>
  ...
  return <h1 className="text-center text-2xl text-gray-100">The page you are looking for does not exist.</h1>;
};
